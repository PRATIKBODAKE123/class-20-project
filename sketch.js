...
var gameOverSound,checkpointSound,bgSound;
//Game States
var PLAY=1;
var END=0;
var gameState=1;
...
function preload(){
  ...
  checkpointSound = loadSound("checkpoint.ogg")
...
function createCash() {
  ...
  cash.scale=0.12;
  cash.velocityY = +(5+treasureCollection/200);
  cash.lifetime = 200;
  cashG.add(cash);
  }
}
...
function createDiamonds() {
  ...
  diamonds.scale=0.03;
  diamonds.velocityY = +(5+treasureCollection/200);
...
function createJwellery() {
  ...
  jwellery.scale=0.13;
  jwellery.velocityY =+(5+treasureCollection/200);
...
function createSword(){
  ...
  sword.scale=0.1;
  sword.velocityY = +(4+treasureCollection/200);
  sword.lifetime = 200;
